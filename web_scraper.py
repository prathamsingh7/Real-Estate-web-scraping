...
# year_path = "/html/body/div[1]/div[1]/main/div[1]/div/form/div[2]/div[1]/div[2]/select/option[31]"
...
#     driver.find_element(By.XPATH, year_path).click()
#     time.sleep(2)
...
# def reg_year():
#     type_year = driver.find_element(By.XPATH, "/html/body/div[1]/div[1]/main/div[1]/div/form/div[3]/div[2]/input")
#     type_year.send_keys("2023")
#     time.sleep(2)
...
# Select the year, district, taluka, village and reg_year
select_year()  
select_district() 
select_taluka()
select_village()
